...
<template>
  <div class="calculadora">
    ...
    <div v-on:click="logbase10" class="botao tarefa">log</div>
    ...
    <div v-on:click="logbasey" class="botao tarefa">logxy</div>
    ...
    <div v-on:click="raizquadrada" class="botao tarefa">²√</div>
    ...
    <div v-on:click="raizxy" class="botao tarefa">raizxy</div>
    ...
    <div v-on:click="potenciade2" class="botao tarefa">x²</div>
    ...
    <div v-on:click="potenciadey" class="botao tarefa">pot</div>
  </div>
</template>
